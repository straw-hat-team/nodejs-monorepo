...
- [@straw-hat/eslint-config-cypress](packages/@straw-hat/eslint-config-cypress/README.md)
- [@straw-hat/eslint-config-nextjs](packages/@straw-hat/eslint-config-nextjs/README.md)
- [@straw-hat/eslint-config-prettier](packages/@straw-hat/eslint-config-prettier/README.md)
- [@straw-hat/eslint-config-react](packages/@straw-hat/eslint-config-react/README.md)
- [@straw-hat/eslint-config-typescript](packages/@straw-hat/eslint-config-typescript/README.md)
...
- [@straw-hat/types](packages/@straw-hat/types/README.md)
- [@straw-hat/webpack-chain-graphql](packages/@straw-hat/webpack-chain-graphql/README.md)
